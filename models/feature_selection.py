...
def main():
    ...
    # Categorical columns identification and encoding
    le = LabelEncoder()
    categorical_cols = housing.select_dtypes(include=['object']).columns  # identify categorical columns
    for col in categorical_cols:
        housing[col] = le.fit_transform(housing[col])  # encode the categorical columns
